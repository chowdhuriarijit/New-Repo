...
<?php if ($page['navigation'] || $main_menu): ?>
      <div id="navigation"><div class="global-wrapper"><div class="section clearfix">
...
<div id="page-wrapper"><?php print render($page['promopanel']); ?><div id="page">
...
<?php if ($logo): ?>
      <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo"><img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" /></a>
    <?php endif; ?>
<?php print render($page['footer']); ?><div class="clr"></div></div></div>
